  ...
  render() {
    return (
      <Layout>
        ...
        <meta name="description" content="Ваш Доктор - официальный партнер лаборатории Гемотест в Чите. У нас Вы сможете пройти весь спектр диагностики и узнать о Ваших болезнях на ранних этапах.
        Мы предлагаем широкий спектр медицинских услуг: сдача всех типов анализов, комплексные обследование, дополнительное мнение экспертов об онкологии, прием гинеколога, ДНК анализы"></meta>
        </Helmet>        
        <Header/>
        <Waypoint
