      ...
      <Layout>
        ...
        <div id="main">
          <section id="content" className="main">
            ...
            <header class="major">
            <h2>АКЦИЯ!</h2>
            <h3>УЗИ молочных желез с цветным доплеровским картированием и УЗИ щитовидной железы 990 рублей (вместо 1510 рублей)</h3>
            </header>
            ...
            <table>
                ...
                <tr>
                  ...
                  <tr>
                    <td>1000₽</td>
										<td>Цервикометрия (3 исследования)</td>
                    <td>А04.20.001.001.07</td>
									</tr>
                  <tr>
                    <td colspan="3" align="center"><strong>УЗИ желез</strong></td>
									</tr>
                  <tr>
                    <td>700₽</td>
