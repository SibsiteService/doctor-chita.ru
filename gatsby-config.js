module.exports = {
  siteMetadata: {
    title: "Где сдать анализы быстро в Чите? Анализы, УЗИ, Гинеколог, комплексные обследования, эндокринолог. - Ваш Доктор. Официальный представитель лаборатории Гемотест в Чите",
